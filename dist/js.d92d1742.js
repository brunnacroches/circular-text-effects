...
},{"./gsap-core.js":26}],22:[function(require,module,exports) {
"use strict";
...
},{"./gsap-core.js":26,"./CSSPlugin.js":27}],17:[function(require,module,exports) {
'use strict';
...
var Intro = exports.Intro = function () {
    function Intro(el) {
        ...
        this.DOM = { el: el };
        // SVG texts
        this.DOM.circleText = [].concat(_toConsumableArray(this.DOM.el.querySelectorAll('text.circles__text')));
        // total
    ...
    _createClass(Intro, [{
        ...
        value: function setup() {
            ...
            _gsap.gsap.set(this.DOM.circleText, { transformOrigin: '50% 50%' });
            // hide on start
            _gsap.gsap.set([this.DOM.circleText, DOM.content.children, DOM.frame.children], { opacity: 0 });
            // don't allow to hover
            _gsap.gsap.set(DOM.enterCtrl, { pointerEvents: 'none' });
        ...
        value: function start() {
            ...
            .add(function () {
                _gsap.gsap.set(DOM.enterCtrl, { pointerEvents: 'auto' });
            }, 'start+=2');
        }
    }, {
        key: 'enter',
        value: function enter() {
            ...
            _gsap.gsap.set([DOM.frame, DOM.content], { opacity: 1 });
...
},{"./utils":16,"gsap":22}],10:[function(require,module,exports) {
'use strict';
...
},{"./utils":16,"./intro":17}],30:[function(require,module,exports) {
...
//# sourceMappingURL=/js.d92d1742.map